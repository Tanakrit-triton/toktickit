...
docker run --name toktickit-db -e POSTGRES\_USER=postgres -e POSTGRES\_PASSWORD=postgres -e POSTGRES\_DB=toktickit -p 5432:5432 -d postgres:16-alpine
...
DATABASE\_URL="postgresql://postgres:postgres@localhost:5432/toktickit"
